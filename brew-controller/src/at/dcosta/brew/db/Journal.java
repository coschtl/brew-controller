...
public class Journal extends Database {
	...
	private static final String[] SQL_CREATE_TABLE = new String[] { "CREATE TABLE " + TABLE_NAME
			+ " (BREW_ID int, STEP varchar(255), TYPE varchar(255), JOURNAL_TEXT varchar(65000)), JOURNAL_DATE timestamp" };

	private static final String SQL_INSERT = "INSERT INTO " + TABLE_NAME
			+ " (BREW_ID, STEP, TYPE, JOURNAL_TEXT,JOURNAL_DATE) values (?, ?, ?, ?, ?)";
	...
	public void getEntry(int cookbookEntryId, String step, String text) {
		Connection con = getConnection();
		PreparedStatement st = null;
		try {
			st = con.prepareStatement(SQL_INSERT);
