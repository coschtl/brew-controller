...
public class MashingSystem extends HeatingSystem {
    ...
    public MashingSystem(int brewId, BrewDB brewDb, NotificationService notificationService, Journal journal) {
    ...
    public void addMalts() {
        ...
        journal.addEntry(getBrewId(), Name.HEAT_WATER, "addMalts", (maltStoreOpenerTimeoutSeconds + maltStoreTimeoutSeconds));
        maltStoreOpener.on();
        try {
    ...
    public void heat(double targetTemperature) throws BrewException {
        ...
        journal.addEntry(getBrewId(), Name.HEAT_WATER, "postHeat", postHeatingSeconds);
    ...
    private boolean isStirrerRunning(int maxWaitSeconds) {
        // FIXME: uncomment when rpm-sensor has been added (HARDWARE!)
